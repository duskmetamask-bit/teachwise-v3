...
export function ErrorChip({ message, onRetry, onDismiss, disabled }: ErrorChipProps) {
  return (
    ...
    >
      ...
      <div className="border-danger/30 bg-danger-soft min-w-0 flex-1 rounded-xl border px-5 py-3">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <p className="text-danger text-caption font-semibold">Failed to generate rubric</p>
